...
👥 The Four Crew Profiles We Need
Every voyage requires a crew of exactly 4 rotating students plus the skipper. While your daily work onboard does not strictly have to be boat-related, your independent project must fall within one of these four fields of expertise:
- IT & Software: (e.g., programming, networking, data visualization, website management, automation).
- Electrical & Woodcrafting: (e.g., solar systems, battery monitoring, mechanical fabrication, sustainable design, physical prototyping).
- Marine Biology & Environment: (e.g., water quality monitoring, microplastic sampling, ecology, climate science).
- Growth & Marketing: (e.g., content creation, documentary filmmaking, community building, NGO crowdfunding strategies).
We are highly open-minded about what your project can be. You can use your time onboard to write a thesis, build an open-source software tool, design a piece of hardware, or create a documentary. However, the practical viability of your project within a mobile, solar-powered environment will be a decisive factor in our selection process.

📋 General Requirements to Join
To ensure the safety of the vessel and a harmonious living environment, all applicants must meet the following baseline criteria:
- Age: Must be over 18 years old.
- Citizenship: Must hold a valid European Union passport (required for smooth legal and border transitions along our routes).
- Education: At least a medium level of academic or vocational studies (VET, University, or advanced self-taught portfolio like School 42) in your chosen field.
- Language: A high level of English is mandatory for safety communication and collaborative work.
- Duration: Minimum stay of 1 month, with a strong preference for students who can commit to 5–6 months to complete a full seasonal rotation.

⚠️ Living & Medical Constraints
Living on a 12-meter catamaran with a 3-meter beam requires high mental and physical resilience. You will be sleeping in a private bunk measuring 2.50m x 1m. Therefore, you must have:
- No claustrophobia or severe discomfort with confined living quarters.
...
- A licensed skipper.
- Basic liveaboard materials (water purification filters, cooking utensils, spare parts) 
What You Cover: 
Students must be fully self-sufficient and able to afford their own personal expenses. This includes:
- Your own food.
- Personal hygiene products.
- Travel expenses to/from the boat's changing locations.
